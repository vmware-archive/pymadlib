...
--
-- Name: auto_mpg_test; Type: TABLE; Schema: public; Owner: gpadmin; Tablespace: 
--
...
ALTER TABLE public.auto_mpg_test OWNER TO gpadmin;

--
-- Data for Name: auto_mpg_test; Type: TABLE DATA; Schema: public; Owner: gpadmin
--
